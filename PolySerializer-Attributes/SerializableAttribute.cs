namespace PolySerializer
{
    ...
    public class SerializableAttribute : Attribute
    {
        ...
        /// </summary>
        public bool ExcludeX { get; set; }

        /// <summary>
        /// Gets or sets a condition for deserializing a member.
        /// If the boolean member indicated by <see cref="ConditionX"/> is set to true, the member with this attribute is serialized, otherwise it is ignored and won't be deserialized.
        /// </summary>
        public string ConditionX { get; set; } = string.Empty;

        /// <summary>
        /// Gets or sets the name of a setter for deserializing a member.
        /// Applies only to read-only properties.
        /// If the member indicated by <see cref="SetterX"/> is a method taking only one argument of the same type, the method is called with the value to deserialize.
        /// </summary>
        public string SetterX { get; set; } = string.Empty;
        ...
        /// </summary>
        public string ConstructorX { get; set; } = string.Empty;
    }
}
